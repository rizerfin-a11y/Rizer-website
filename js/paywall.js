      ...
      <div class="paywall-card">
        ...
        <div class="paywall-plans">
          ...
          <div class="paywall-plan" id="plan-monthly">
            ...
            <button class="paywall-btn paywall-btn-primary" onclick="initiatePayment('monthly', 29900)">
              Subscribe Monthly
            </button>
          </div>
          ...
          <div class="paywall-plan paywall-plan-featured" id="plan-lifetime">
            ...
            <h3>Lifetime</h3>
            <div class="paywall-price">₹999 <span>one time</span></div>
            <ul class="paywall-features">
            ...
            <button class="paywall-btn paywall-btn-featured" onclick="initiatePayment('lifetime', 99900)">
              Get Lifetime Access
            </button>
          </div>
        </div>
